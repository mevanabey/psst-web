    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center justify-center w-full h-full">
                ...
                > */}
                    {/* <h1 className="text-6xl md:text-8xl font-light bg-clip-text text-transparent bg-gradient-to-b from-black to-black/70 dark:from-white dark:to-white/70 drop-shadow-sm">
                        {title}
                    </h1>
                    ...
                    <Image src="/bg-img-2.png" alt="Logo" width={150} height={650} className="fixed rotate-40 sm:rotate-55 -bottom-20 sm:-bottom-10 scale-100 sm:scale-150  mx-auto left-10 sm:left-40 opacity-80" /> 
                {/* </motion.div> */}
            </div>
        </div>
    );

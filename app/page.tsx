...
export default function Home() {
  return (
      <div className="fixed inset-0 bg-black flex flex-col items-center justify-center">
        ...
        >
          <Logo className="w-48 sm:w-64 md:w-80 text-white mx-auto mb-8" />
          <div className="text-lg sm:text-xl md:text-2xl text-gray-300 uppercase tracking-wide flex items-center justify-center">

...
export default function Home() {
  return (
      <>
          <div className="fixed bottom-0 right-0 z-10 flex justify-end p-6 sm:p-8 flex-col text-right gap-4 text-gray-300">
            <div className="flex flex-col gap-4 mb-2">
                <Link href="/order" className="uppercase text-md sm:text-2xl relative group flex items-center justify-end -mr-2" scroll={true} prefetch={true}>
                  <motion.span 
                    className="relative -mt-0.5 mr-2 font-bold"
                  ...
                  <motion.span
                    className="text-gray-300 hover:text-white cursor-pointer font-medium tracking-wide relative"
                    initial={{ scale: 1 }}
                ...
                <Link href="/contact" className="uppercase text-md sm:text-2xl relative group flex items-center justify-end -mr-2" scroll={true} prefetch={true}>
                  <motion.span 
                    className="relative -mt-0.5 mr-2 text-gray-100 font-bold"
                    initial={{ opacity: 1, x: 0 }}
                    whileHover={{ opacity: 1, x: 0 }}
                    whileTap={{ scale: 0.95, x: 0 }}
                  >
